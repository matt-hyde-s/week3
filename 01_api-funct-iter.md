...
For starters, let’s try accessing the **total/{year}**. This data set
...
… where NAME is what we want to name the function; ARGUMENTS are the
...
At this point, we now know how to develop functions so that we do not
